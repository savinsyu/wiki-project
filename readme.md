...
## Описание функционала
 ...
 - Реализован поиск по всем разделам, которые имеют записи (разделы cli, sql, python);
 - Реализована пагинация страниц с разбивкой по 10 записей на страницу(разделы cli, sql, python);
 - В разделе "Сервисы" есть возможность сделать дамп базы данных;
 - В разделе "Сервисы" реализован вывод списка файлов созданных бэкапов, а также возможность их удалить;
 - В разделе "Сервисы" реализована возможность выгружать данные таблиц баз данных в файл excel;
 - В разделе "Сервисы" реализована возможность скачать файлы бэкапа и excel;
 - Добавлена возможность отправки коммита на репозиторий с кнопки в разделе "Сервисы";
 - Добавлен сервис генерации пароля в разделе "Сервисы";
