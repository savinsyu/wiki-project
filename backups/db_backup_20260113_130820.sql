...
INSERT INTO "links" VALUES(6,'https://www.sqlite.org/autoinc.html','Автоинкремент в SQLite');
INSERT INTO "links" VALUES(7,'https://bi-data.ru/tools/sql/','SQL форматтер');
CREATE TABLE "python" (
...
INSERT INTO "wiki" VALUES('Настраиваем внешние взаимодействия регистрации.sdf sdfsdf','Настраиваем внешние взаимодействия регистрации. dsfsdfds','2025-12-26 08:26:56','2025-12-29 12:22:07',3);
INSERT INTO "wiki" VALUES('sdfffffffffffffffff','sdfffffffffffff','2025-12-29 09:16:07',NULL,4);
DELETE FROM "sqlite_sequence";
INSERT INTO "sqlite_sequence" VALUES('python',2131);
INSERT INTO "sqlite_sequence" VALUES('cli',241);
INSERT INTO "sqlite_sequence" VALUES('sql',1181);
INSERT INTO "sqlite_sequence" VALUES('about',16);
INSERT INTO "sqlite_sequence" VALUES('links',7);
COMMIT;
